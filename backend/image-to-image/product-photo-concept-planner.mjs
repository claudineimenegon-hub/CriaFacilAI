...
const archetypes = {
  ...
  luxuryDisplay: concept('LUXURY DISPLAY', 'refined premium display', 'medium close product view', 'low or three-quarter showcase angle', '70–100 mm product-photography perspective', 'asymmetric premium display with disciplined negative space', 'restrained pedestal, display, boutique surface, glass, stone, wood, or textile suited to the category', 'sculpted studio key with controlled contrast and refined accent highlights', 'product sharp with layered background depth', false, 'Product presented independently in a commercial still-life arrangement.'),
