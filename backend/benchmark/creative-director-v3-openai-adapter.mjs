...
const SYSTEM_INSTRUCTIONS = [
  ...
  'For concept_campaign, use selective visibility: select exactly one independent canonical item, or exactly one complete protected atomic relationship. Never combine different canonical functional types in this role. Keep every omitted canonical ID absent rather than echoing it as decoration, silhouette, prop or transformed motif.',
...
function visibilityInstructions(normalizedInput) {
  return [
    ...
    'CONCEPT_CAMPAIGN must choose exactly one independent canonical item or one complete protected atomic relationship. Use exact canonical quantity, explicitly omit every other ID, and never imitate an omitted product type, silhouette or geometry in props or decoration. Its freedom applies to scene, light, surface, environmental color and framing, never canonical product identity or components.',
